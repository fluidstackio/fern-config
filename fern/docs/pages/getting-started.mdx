...
When creating an instance, you must provide an SSH key. The SSH key is used for command-line access to the running instance. You can use the same SSH key for multiple instances.
