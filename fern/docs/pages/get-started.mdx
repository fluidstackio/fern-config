...
When you have successfully logged in, notice that your command prompt has changed. All commands that you enter into this command prompt are executed on your instance. The instance is ready for use!
