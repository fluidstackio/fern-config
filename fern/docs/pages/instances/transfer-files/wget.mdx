...
For more details on how to use `wget`, refer to the [GNU.org wget manual](https://www.gnu.org/software/wget/manual/) or enter `man wget` in a Linux terminal for the manual page.