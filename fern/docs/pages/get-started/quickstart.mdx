...
```
    To confirm that your instance was deleted, call the [`List user instances`](/api-reference/instances/list) endpoint again as you did at the end of Step 1.
...
- Learn how to [programmatically manage instances](/instances/programmatic-instance-management).