...
An SSH key can be created using a command-line tool such as [cURL](https://curl.se/) or programmatically, using the [`POST /ssh_keys`](/api-reference/ssh-keys/create) endpoint:
