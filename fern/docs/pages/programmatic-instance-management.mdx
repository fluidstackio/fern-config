...
<Steps>
    ### Create an SSH key
      ...
      The script reads the public key located at `~/.ssh/id_rsa.pub` and sends a POST request to create a new SSH key named `"my_key"`. If your public key is in a different location or filename, update this part of the script before you use it.
